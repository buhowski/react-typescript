...
const projectsData = [
	{
		...
		description: `High‑performance multilingual SPA`,
		skills: ['React', 'TypeScript', 'Canvas', 'SCSS', 'PWA', 'SEO', 'UI/UX'],
...

	{
		...
		description: '2024 | Custom WordPress e‑commerce with optimized UI/UX',
		skills: ['JavaScript', 'SCSS', 'WordPress', 'PHP'],
...

	{
		...
		name: 'Potion AI',
		description: `2022 | Motion‑driven UI with GSAP animations`,
...

	{
		...
		name: 'Nascent Design',
		description: `2021 | Responsive Design with GSAP animations`,
...

	{
		...
		description: '2022 | Pixel Perfect WordPress e‑commerce with GSAP & Barba.js transitions',
...

	{
		...
		name: 'Faber Academy',
		description: '2021 | Pixel Perfect WordPress e‑commerce with GSAP animations',
...

	{
		...
		name: 'Faber',
		description: '2021 | Pixel Perfect WordPress e‑commerce with responsive UI/UX',
...

	{
		...
		name: 'Somos ENDE',
		description: '2019 | Responsive site with custom animations',
...

	{
		...
		description: '2019 | Responsive site with Barba.js transitions',
