...
const projectsData = [
	{
		...
		desk: `Project design and structure — Create React App, React Hooks and TypeScript. Page animation – React Transition Group and React Router Dom. Styles and custom fonts – SCSS + font files. Custom scrollbar – React SimpleBar. For webpack config – CRACO. Testing – Jest.`,
...

	{
		...
		skills: ['Twig', 'SCSS', 'JavaScript', 'GSAP', 'Pixel Perfect', 'WordPress'],
	},
...

	{
		...
		skills: ['Twig', 'SCSS', 'JS/ES6', 'GSAP', 'Pixel Perfect', 'WordPress'],
	},
