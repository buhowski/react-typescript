		...
		section: [
			{
				...
				text: [
					...
					`Ідея серіалу використовує гумор та сатиру, щоб гостро, з іронією, та водночас проникливо відобразити недоліки та досягнення України на шляху до європейської інтеграції. Також будуть показані стереотипи та культурні особливості кожної європейської країни через призму української реальності. Перед глядачем відкривається реальність українського життя – від глибин сільської місцевості до пульсуючого серця столиці. Це серіал для людей, які не бояться сміятися над проблемами, але при цьому хочуть, щоб їхні голоси були почуті. Я вірю, що він може змінити українське суспільство на краще.`,
				],
				subtitle: `Ідея сюжету:`,
				list: [
					`Головні герої – це звичайні люди різних поколінь, у яких грошовий дефіцит – їх постійний супутник, але які з усіх сил намагаються розвиватися і досягти успіхів у житті.`,
					`Кожна серія – це нова пригода з життя головних героїв, в якій вони стикаються з різними проблемами та викликами українського суспільства, як корупція, безкультур'я, гендерна нерівність, застаріле бачення, насилля, залежності, безробіття та багато іншого в такому дусі.`,
					`Показати реальність без цензури, з душевним гумором і висміюванням реально існуючих ситуацій.`,
			...
			},
			{
				title: `Мета`,
				text: [
					`Я вірю, що з новим підходом до реалізації і більш професійним відношенням до передачі емоцій картиною – новий формат українського комедійного серіалу стане справжнім хітом і візитною карткою України на світовому телевізійному ринку, для подальших інвестицій на розвиток наступних ідей, бо ідей безмежна кількість і є з чим працювати, але потрібні ресурси.`,
