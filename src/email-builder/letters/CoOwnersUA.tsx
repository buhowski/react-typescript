...
const CoOwnersUA = ({ lang }: { lang?: string }) => {
	return (
		<EmailLayout lang={lang}>
			{/* Preview Subject */}
			<EmailPreheader text='Шукаю спільників для запуску альтернативної операційної системи реальності' />

			<EmailHeader />

			<EmailText content='Привіт.' />

			<EmailText content='Я Олександр — ідейний розробник, сценарист і дослідник. Створюю незалежний медіапростір. Пишу з пропозицією про співпрацю.' />
