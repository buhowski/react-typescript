...
const CoOwnersUA = ({ lang }: { lang?: string }) => {
	return (
		<EmailLayout lang={lang}>
			...
			<EmailText content='Розробляю контркультурну екосистему з ядром у вигляді журналу та соцмережі. Вона масштабуватиметься у кіновиробництво, геймдев та IT. Додатково інтегруються стрімінг і хаб для дистрибуції власних проєктів. Мета — змінювати сприйняття реальності, пропагандуючи здоровий глузд.' />
